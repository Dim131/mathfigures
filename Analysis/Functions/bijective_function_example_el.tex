...
\fill[Yellow,rounded corners] (5, 0.5) rectangle (6, -3.75);
...
\draw[->,line width=1pt] (a1) -- (b3);
\draw[->,line width=1pt] (a2) -- (b4);
\draw[->,line width=1pt] (a3) -- (b2);
\draw[->,line width=1pt] (a4) -- (b1);
