...
\definecolor{VecClr}{RGB}{242,190,63}

\tikzset{
Vec/.style={postaction=decorate,draw=VecClr,
    decoration={markings, mark=at position .5 with {\arrow[thick]{stealth}}
    } }}
...
\tkzDefPoints{0/0/B,1.4/3/A,5/0/C,2/-2/O}
...
\tkzDrawSegments[line width=0.75pt,Vec](O,A O,B O,C O,G)
\tkzDrawPolygon[color=ShapeClr](A,B,C)
\tkzDrawPoints[size=3](A,B,C,G,O)
