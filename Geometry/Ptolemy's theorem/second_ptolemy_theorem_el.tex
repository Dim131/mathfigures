...
\tkzLabelSegments[scale=0.75,left](B,A){$\alpha$}
\tkzLabelSegments[scale=0.75,below=-0.05cm,sloped](B,C){$\beta$}
\tkzLabelSegments[scale=0.75,left](C,D){$\gamma$}
\tkzLabelSegments[scale=0.75,above,sloped](D,A){$\delta$}
