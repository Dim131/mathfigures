...
\tkzDefPoints{0/0/B,0.7/3.5/A,5/0/C,2/1.1/P}
...
\tkzFillPolygon[fill=ShapeClr,fill opacity=0.1](PA,PB,PC)
\tkzDrawPolygon[color=ShapeClr](PA,PB,PC)
...
\tkzLabelPoint[above right](PB){$\rm P_B$}
