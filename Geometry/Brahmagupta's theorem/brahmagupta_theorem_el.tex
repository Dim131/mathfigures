...
\tkzMarkRightAngle[line width=0.5pt, size=.25,color=AngleClr,fill=AngleClr,fill opacity=0.2](B,I,A)

\tkzDefMidPoint(A,D) \tkzGetPoint{M}
\tkzInterLL(M,I)(B,C) \tkzGetPoint{H}


\tkzMarkRightAngle[line width=0.5pt, size=.25,color=AngleClr,fill=AngleClr,fill opacity=0.2](I,H,C)
