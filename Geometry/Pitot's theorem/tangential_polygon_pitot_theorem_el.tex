...
\tkzLabelPoint[above right,scale=0.75](Ia){${\rm I}_{2n}$}
\tkzLabelPoint[below right,scale=0.75](Ib){${\rm I}_{2n-1}$}
...
\tkzLabelPoint[right](B){${\rm P}_{2n}$}
\tkzLabelPoint[below right](C){${\rm P}_{2n-1}$}
...
\tkzLabelSegments[below,sloped,scale=0.7](B,Ia){$x_{2n}$}
\tkzLabelSegments[above,sloped,scale=0.7](B,Ib){$x_{2n}$}

\tkzLabelSegments[above,sloped,scale=0.7](C,Ib){$x_{2n-1}$}
