...
\tkzLabelSegments[above right](A,Id){$x$}
\tkzLabelSegments[above left](B,Ia){$y$}
\tkzLabelSegments[below left](C,Ib){$z$}
\tkzLabelSegments[below right](D,Ic){$w$}

\tkzLabelSegments[above left](A,Ia){$x$}
\tkzLabelSegments[below left](B,Ib){$y$}
\tkzLabelSegments[below right](C,Ic){$z$}
\tkzLabelSegments[above right](D,Id){$w$}
