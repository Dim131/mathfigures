...
\tkzMarkRightAngles[line width=0.5pt, size=.2,color=AngleClr,fill=AngleClr,fill opacity=0.1](P1,P3,P5)

\tkzDrawSegments[line width=1pt](P1,P3 P1,P5)
\tkzDrawSegments[line width=0.5pt,color=black,dashed,dash pattern=on 1pt off 1.75pt](P3,P5)
...
\tkzLabelSegment[below right](P1,P3){$d_1$}
\tkzLabelSegment[above right](P3,P5){$d_1$}
