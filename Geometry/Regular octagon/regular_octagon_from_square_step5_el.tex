...
% Step 5
\tkzDrawPolygon[color=black,line width=0.8pt](A,B,C,D)
\tkzInterLC(M1,M2)(O,A) \tkzGetPoints{E}{F}
\tkzInterLC(M3,M4)(O,A) \tkzGetPoints{G}{H}
\tkzDrawPolygon[color=ShapeClr,line width=1pt](A,E,B,G,C,F,D,H)
\tkzDrawPoints[size=3](E,F,G,H)
