...
\tkzDefPoints{0/0/A,6/0/C,2/1.5/D,2/-4/B}
...
\tkzMarkRightAngles[line width=0.25pt, size=.1,color=black,fill=black,fill opacity=0.2](M1,Z3,D M2,Z4,A M3,Z1,B M4,Z2,C)
...
\tkzLabelPoint[below right](M2){$\rm M_2$}
\tkzLabelPoint[above right](M3){$\rm M_3$}
\tkzLabelPoint[above left](M4){$\rm M_4$}

\tkzLabelPoint[scale=0.75,below left](Z1){$\rm Z_1$}
\tkzLabelPoint[scale=0.75,xshift=0.085cm,below](Z2){$\rm Z_2$}
\tkzLabelPoint[scale=0.75,above right](Z3){$\rm Z_3$}
\tkzLabelPoint[scale=0.75,above left](Z4){$\rm Z_4$}
