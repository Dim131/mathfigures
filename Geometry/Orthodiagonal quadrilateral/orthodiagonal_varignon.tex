...
\tkzFillPolygon[fill=BlueClr,fill opacity=0.2,inner sep=1cm](M1,M2,M3,M4)

\tkzMarkRightAngle[line width=0.5pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.2](B,I,C)
