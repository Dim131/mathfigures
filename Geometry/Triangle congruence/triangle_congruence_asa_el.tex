...
\tkzMarkAngles[mark=||,mksize=2,line width=1pt,color=AngleClr,size=.4](C,B,A Z,E,D)

\tkzFillAngles[fill=BlueSqr,size=.4,fill opacity=0.2](A,C,B D,Z,E)
\tkzMarkAngles[mark=|,mksize=2,line width=1pt,color=BlueSqr,size=.4](A,C,B D,Z,E)
