...
\tkzDrawSegments[color=AngleClr](P,A)
\tkzDrawSegments[color=orange](P,B)
\tkzDrawSegments[color=blue](P,C)

\tkzDrawCircle[color=black,line width=0.6pt](O,A)
\tkzDrawCircles[color=AngleClr,line width=0.4pt](MA,A)
\tkzDrawCircles[color=orange,line width=0.4pt](MB,B)
\tkzDrawCircles[color=blue,line width=0.4pt](MC,C)
