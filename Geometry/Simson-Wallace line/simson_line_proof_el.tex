...
\tkzFillAngles[line width=0.5pt, size=.45,fill=BlueAngleClr,fill opacity=0.2](PC,P,A PC,PB,A)
\tkzLabelAngle[scale=0.55,pos=1.6](PC,PB,A){$\varphi$}

\tkzMarkAngles[line width=0.5pt, size=.45,color=YellowAngleClr](PA,PB,C PA,P,C)
\tkzFillAngles[line width=0.5pt, size=.45,fill=YellowAngleClr,fill opacity=0.2](PA,PB,C PA,P,C)
\tkzLabelAngle[scale=0.55,pos=1.6](PA,PB,C){$\omega$}

\tkzMarkRightAngles[line width=0.5pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.2](P,PA,C P,PB,A P,PC,B)
