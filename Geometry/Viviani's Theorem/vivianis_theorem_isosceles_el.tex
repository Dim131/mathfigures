...
\tkzMarkRightAngles[line width=0.7pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.1](P,PA,B P,PB,A P,PC,A A,HA,B)
...
\tkzLabelSegment[left](A,HA){\scalebox{0.75}{$~~~~u$}}
