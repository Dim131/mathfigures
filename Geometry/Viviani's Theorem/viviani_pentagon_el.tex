...
\tkzMarkRightAngles[line width=0.7pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.2](P,D1,P1 P,D2,P2 P,D3,P3 P,D4,P4 P,D5,P5)
...
\tkzLabelSegment[left=-1.5pt](P,D1){\scalebox{0.75}{$d_5$}}
\tkzLabelSegment[above=-1.5pt](P,D2){\scalebox{0.75}{$d_4$}}
\tkzLabelSegment[left=-1.5pt,pos=0.6](P,D3){\scalebox{0.75}{$d_3$}}
\tkzLabelSegment[above](P,D4){\scalebox{0.75}{$d_2$}}
\tkzLabelSegment[above=-1.5pt](P,D5){\scalebox{0.75}{$d_1$}}
