...
\tkzMarkRightAngles[line width=0.7pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.2](P,PA,B P,PB,C P,PC,A A,HA,B)
...
\tkzLabelSegment[scale=0.75,left, pos=0.8](A,HA){$~~~~\upsilon$}
\end{tikzpicture}
