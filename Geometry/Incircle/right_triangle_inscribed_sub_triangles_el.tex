...
\tkzMarkRightAngles[line width=0.6pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.1](R,H,C A,Rx,R B,Ry,R)
...
\tkzLabelPoint[left](Rx){$\rm \Delta$}
\tkzLabelPoint[below](Ry){$\rm Z$}
\tkzLabelPoint[above right](H){$\rm E$}
