...
\tkzDefPoints{0/0/B,6/0/C,1.05/3.75/A}
...
\tkzLabelSegment[right,scale=0.75,pos=0.5](A,I){$\delta_\alpha$}
\tkzLabelSegment[above,scale=0.75,pos=0.5](B,I){$\delta_\beta$}
\tkzLabelSegment[below,scale=0.75,pos=0.5](C,I){$\delta_\gamma$}
