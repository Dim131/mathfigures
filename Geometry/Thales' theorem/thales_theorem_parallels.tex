...
\tkzDrawSegments[line width=0.5pt,color=black,add=0.1 and 0.1](S,B S,D)
...
\tkzLabelPoint[above](S){$\rm \Sigma$}

\tkzLabelPoint[right=0.55cm](C){$\varepsilon_1$}
\tkzLabelPoint[right=0.55cm](D){$\varepsilon_2$}
