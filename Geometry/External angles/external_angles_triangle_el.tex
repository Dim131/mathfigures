...
% Internal angles.
\tkzFillAngles[fill=AngleClr,size=.55,fill opacity=0.2](C,B,A A,C,B B,A,C)
\tkzMarkAngles[line width=1.6pt,size=.55,color=AngleClr](C,B,A A,C,B B,A,C)

% External angles.
\tkzFillAngles[fill=SecondAngleClr,size=.4,fill opacity=0.2](A,B,B2 A1,B,C B,C,C2 C,A,A2 C1,A,B B1,C,A)
\tkzMarkAngles[line width=1.4pt,size=.4,color=SecondAngleClr](A,B,B2 A1,B,C A1,B,C B,C,C2 C,A,A2 C1,A,B B1,C,A)
