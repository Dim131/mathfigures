...
\tkzLabelPoint[above right](A){$\rm B$}
\tkzLabelPoint[below](B){$\rm \Gamma$}
...
\tkzLabelSegment[below](B,H){\scalebox{0.75}{$y$}}
\tkzLabelSegment[right](B,H3){\scalebox{0.75}{$y$}}

\tkzLabelSegment[right](A,H3){\scalebox{0.75}{$x$}}
\tkzLabelSegment[above](A,H2){\scalebox{0.75}{$x$}}
\tkzLabelSegment[below](B,C){\scalebox{0.75}{$\beta$}}
\tkzLabelSegment[above](C,A){\scalebox{0.75}{$\gamma$}}
