...
\tkzFillAngle[fill=UnknownLabelClr,size=.44,fill opacity=0.1](A,C,B)
\tkzMarkAngle[line width=1pt,size=.45,color=UnknownLabelClr](A,C,B)
\tkzLabelAngle[pos=0.7,UnknownLabelClr](A,C,B){$?$}
