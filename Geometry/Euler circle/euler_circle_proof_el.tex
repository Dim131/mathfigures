...
\tkzMarkRightAngles[line width=0.5pt, size=.15,color=AngleClr,fill=AngleClr,fill opacity=0.2](A,HA,C B,HB,A C,HC,B)
...
\tkzDrawPoints[size=2](HA,HB,HC,MA,MB,MC,MMA,MMB,MMC,O,H)
