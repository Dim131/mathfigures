...
\tkzDrawSegments[line width=0.5pt,color=black,dashed,dash pattern=on 1pt off 1.75pt](P,PA P,A P,B P,C)
\tkzDrawSegments[line width=0.5pt,color=black,dashed,dash pattern=on 1pt off 1.75pt,add=0 and 0.75](P,PC)
\tkzDrawSegments[line width=0.5pt,color=black,dashed,dash pattern=on 1pt off 1.75pt,add=0 and 2](P,PB)

\tkzLabelSegment[below,pos=3.7](P,PB){$\epsilon_\mathrm{B}$}
\tkzLabelSegment[left,pos=1.7](P,PC){$\epsilon_\mathrm{\Gamma}$}
