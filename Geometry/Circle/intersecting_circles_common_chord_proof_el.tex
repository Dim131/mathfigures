...
\tkzFillPolygon[fill=ShapeClr,fill opacity=0.1](O1,C,O2)
...
\tkzMarkRightAngles[line width=1pt, size=.2,color=AngleClr,fill=AngleClr,fill opacity=0.2](O1,X,C)

\tkzDrawSegments[line width=1pt,color=black](O1,O2 C,D O1,C O2,C)

\tkzDrawPoints[size=3](O1,O2,C,D,X)
\tkzLabelPoint[below](O1){$\rm O_1$}
\tkzLabelPoint[below](O2){$\rm O_2$}
\tkzLabelPoint[above](C){$\rm A$}
\tkzLabelPoint[below](D){$\rm B$}
\tkzLabelPoint[below left](X){$\rm M$}

\tkzMarkSegments[mark=s||,size=2](C,X X,D)
