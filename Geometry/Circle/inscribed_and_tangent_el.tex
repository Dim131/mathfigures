...
\tkzLabelAngles[scale=0.8,pos=1.1](C,B,A h,C,A){$\varphi$}

\tkzFillAngles[fill=ShapeClr,size=.55,fill opacity=0.2](O,A,C A,C,O)
\tkzMarkAngles[mark=s,mksize=2,line width=1pt,size=.55,color=ShapeClr](O,A,C A,C,O)
\tkzLabelAngles[scale=0.8,pos=1.1](O,A,C A,C,O){$\omega$}
