...
\tkzDefPoints{0/0/B,4/0/C,0/2.75/A,4/2.75/D,2/1.5/O,2.8/1.7/P}
...
\tkzLabelPoint[scale=0.75,left](P1){${\rm P}_1$}
\tkzLabelPoint[scale=0.75,below](P2){${\rm P}_2$}
\tkzLabelPoint[scale=0.75,right](P3){${\rm P}_3$}
\tkzLabelPoint[scale=0.75,above](P4){${\rm P}_4$}
