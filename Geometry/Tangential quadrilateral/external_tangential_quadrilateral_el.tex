...
\tkzLabelPoint[above right](Id){${\rm I}_\alpha$}
\tkzLabelPoint[above](Ib){${\rm I}_\beta$}
\tkzLabelPoint[above right](Ic){${\rm I}_\gamma$}
\tkzLabelPoint[above left](Ia){${\rm I}_\delta$}
