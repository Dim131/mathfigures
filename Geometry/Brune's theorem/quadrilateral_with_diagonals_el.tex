...
\tkzFillPolygon[fill=AngleClr,fill opacity=0.1](M1,B,M2,O)
\tkzFillPolygon[fill=BlueClr,fill opacity=0.1](M2,C,M3,O)
\tkzFillPolygon[fill=RedClr,fill opacity=0.1](M3,D,M4,O)
\tkzFillPolygon[fill=YellowClr,fill opacity=0.1](M4,A,M1,O)
