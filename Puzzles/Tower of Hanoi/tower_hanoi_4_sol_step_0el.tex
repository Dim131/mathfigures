...
\draw[fill=PurpleClr,draw=none] (1,1) rectangle ++(4,0.75);
\draw[fill=GreenClr,draw=none] (1.5,1.75) rectangle ++(3,0.75);
\draw[fill=RedClr,draw=none] (2,2.5) rectangle ++(2,0.75);
\draw[fill=BlueClr,draw=none] (2.5,3.25) rectangle ++(1,0.75);
