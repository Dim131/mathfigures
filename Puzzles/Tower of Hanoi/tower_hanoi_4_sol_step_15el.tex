...
\draw[fill=PurpleClr,draw=none] (11,1) rectangle ++(4,0.75);
\draw[fill=GreenClr,draw=none] (11.5,1.75) rectangle ++(3,0.75);
\draw[fill=RedClr,draw=none] (12,2.5) rectangle ++(2,0.75);
\draw[fill=BlueClr,draw=none] (12.5,3.25) rectangle ++(1,0.75);
